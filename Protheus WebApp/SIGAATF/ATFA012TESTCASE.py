...
class ATFA012(unittest.TestCase):
    ...
    def test_ATFA012_003(self):
        ...
        self.oHelper.WaitProcessing("Processando Conversão...")
        ...
        self.oHelper.CheckResult("N3_DPDEPR", "Linear com Valor Max. Depreciacao", grid=True, line=1)
        self.oHelper.CheckResult("N3_CCONTAB", "ATF012TC", grid=True, line=1)
        self.oHelper.CheckResult("N3_VORIG1", "5.000,00", grid=True, line=1)
        self.oHelper.CheckResult("N3_VMXDEPR", "4.000,00", grid=True, line=1)
        self.oHelper.CheckResult("N3_DPDEPR", "Linear", grid=True, line=2)
        self.oHelper.CheckResult("N3_CCONTAB", "ATF012TC", grid=True, line=2)
        self.oHelper.CheckResult("N3_VORIG1", "5.000,00", grid=True, line=2)
        self.oHelper.LoadGrid()        
    ...
    def test_ATFA012_006(self):
        ...
        self.oHelper.SetValue("N3_VRDACM1", "1.000,00", grid=True, grid_number=1, row=2)
        self.oHelper.LoadGrid()
    ...
    def test_ATFA012_012(self):
        ...
        self.oHelper.SetValue("MV_PAR01", "\\baseline\\sn3import.csv", )
    ...
    def test_ATFA012_013(self):
        ...
        #Posiciona no registro
        self.oHelper.SearchBrowse(f"{codigo}")     #"D RJ 01 ATFTIR012 0001    "
