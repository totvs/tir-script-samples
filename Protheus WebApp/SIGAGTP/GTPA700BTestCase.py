...
class GTPA700B(unittest.TestCase):
    ...
    def test_GTPA700B_CT001(self):
        ...
        self.oHelper.ClickLabel("+ Depósitos")

        self.oHelper.ClickGridCell("Status Depos", row=1, grid_number=2)
        self.oHelper.SetValue("Status Depos", "1 - Aceito",
                              grid=True, grid_number=2)
