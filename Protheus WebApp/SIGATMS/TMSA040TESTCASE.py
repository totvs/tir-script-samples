...
class TMSA040(unittest.TestCase):
	...
	def test_TMSA040_CT009(self):
		self.oHelper.Setup('SIGATMS','19/06/2019','T1','M SP 01 ','43')
	...
	def test_TMSA040_CT026(self):
		...
		#self.oHelper.AddParameter("MV_TMSCFEC", "", ".T.")
		#self.oHelper.AddParameter("MV_CLICOT", "", ".T.")
		self.oHelper.AddParameter("MV_COTVFEC", "", ".T.")
		self.oHelper.AddParameter("MV_PRDDIV" , "",".T.")	
		self.oHelper.AddParameter("MV_TMSRRE", "", "2")
		self.oHelper.SetParameters()	
		...
		self.oHelper.ClickGridCell("Produto", row=2)
