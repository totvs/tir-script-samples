...
class MATA242(unittest.TestCase):
	...
	def test_MATA242_CT005(self):

		self.oHelper.SetButton('Incluir')
		self.oHelper.SetButton('Ok')
		self.oHelper.SetValue('Produto Origem','EST000000000000000000000000030')
		self.oHelper.SetValue('Armazem','01')

		self.oHelper.SetValue("Produto", "EST000000000000000000000000031", grid=True)
		self.oHelper.SetValue("Quantidade", "1,00", grid=True)
		self.oHelper.SetValue("% Rateio", "100,00", grid=True)
		self.oHelper.LoadGrid()

		self.oHelper.SetButton('Salvar')

		self.oHelper.WaitShow("MA242PR")
		self.oHelper.CheckHelp(text_help="MA242PR", button="Fechar")
