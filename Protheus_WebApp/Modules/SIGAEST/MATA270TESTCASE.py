...
class MATA270(unittest.TestCase):
	...
	def setUpClass(inst):
		inst.oHelper = Webapp()
		inst.oHelper.Setup("SIGAEST","26/11/2020","T1","D MG 01")
	...
	def test_MAT270_008(self):
		self.oHelper.SetKey("F12")
		self.oHelper.SetValue("Valida Existencia do Produto ?","Sim")
		self.oHelper.SetValue("Sugere inform. inventario ?","Por Codigo")
		self.oHelper.SetValue("Data p/ opcao sel. autom. ?","26/11/2020")
		self.oHelper.SetValue("Selecionar contagem por ?","Produto")
		self.oHelper.SetValue("Data da contagem ?","26/11/2020")
		self.oHelper.SetValue("Contagem ?","1")
		self.oHelper.SetButton("Ok")
		self.oHelper.SetButton("Incluir")
		self.oHelper.SetButton("Ok")
		self.oHelper.SetValue("Produto","ESTSE0000000000000000000000403")
		self.oHelper.SetValue("Armazem","01")		
		self.oHelper.SetValue("Quantidade","1,00")
		#self.oHelper.SetValue("Documento","000000077")
		self.oHelper.SetFocus("Lote")
		self.oHelper.SetValue("Lote","X01")
