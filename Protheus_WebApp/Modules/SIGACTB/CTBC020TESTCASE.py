...
class CTBC020(unittest.TestCase):
    ...
    def setUpClass(inst):
        ...
        inst.oHelper.Program("CTBC020")

    def test_CTBC020_001(self):

        self.oHelper.SetValue("Data Inicial ?"              ,"13/07/2015")
        self.oHelper.SetValue("Data Final ?"                ,"13/07/2015")
        self.oHelper.SetValue("Qual a moeda ?"              ,"01")
        self.oHelper.SetValue("Qual Tipo Saldo ?"           ,"1")
        self.oHelper.SetValue("Saldo p/ Comparacao ?"       ,"2")
