...
class CTBA093(unittest.TestCase):
    ...
    def test_CTBA093_006(self):
        ...
        self.oHelper.SetValue("CWK_CUENTA", "M_A1_CONTA", name_attr=True)
        self.oHelper.CheckResult("CWK_CUENTA",  "M_A1_CONTA", name_attr=True)

        self.oHelper.ClickFolder("Formulação")

        self.oHelper.SetValue("Operador",   "01 - SOMA",    grid=True,row=1)
        self.oHelper.SetValue("Operador 1",  "M_B1_PRV1",    grid=True,row=1)
        self.oHelper.SetValue("Operador 2",  "M_A3_COMIS",    grid=True, row=1)
        self.oHelper.LoadGrid()

        self.oHelper.CheckResult("Operador",    "SOMA", grid=True, line=1)
        self.oHelper.CheckResult("Operador 1",   "M_B1_PRV1",  grid=True, line=1)
        self.oHelper.CheckResult("Operador 2",   "M_A3_COMIS",   grid=True, line=1)
        self.oHelper.LoadGrid()

        self.oHelper.SetButton("Gerar fórmula")
        self.oHelper.CheckResult("CWK_ADVPL", "SA1->A1_CONTA", name_attr=True)
        self.oHelper.SetButton("Confirmar")
        self.oHelper.SetButton("Fechar")
