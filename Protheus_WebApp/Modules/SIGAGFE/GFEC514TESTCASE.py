...
class GFEC514(unittest.TestCase):

    @classmethod
    def setUpClass(inst):
        inst.oHelper = Webapp()
        inst.oHelper.Setup("SIGAGFE", "25/06/2020", "T1", "D MG 01", "78")
        inst.oHelper.Program("GFEC514")

    def test_GFEC514_CT001(self):   
        filial_de = 'D MG 01'
        filial_ate = 'D MG 01'      
        data_ini = '01/11/2018'
        data_fim = '30/11/2018'
        ...
        self.oHelper.SetValue('Data Movimentacao de ?',data_ini)
        self.oHelper.SetValue('Data Movimentacao ate ?',data_fim)
