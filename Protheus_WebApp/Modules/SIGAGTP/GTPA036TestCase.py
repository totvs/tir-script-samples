...
class GTPA036(unittest.TestCase):
    ...
    def test_GTPA036_CT001(self):
        self.oHelper.SetButton('Avançar')
        self.oHelper.ClickLabel("Arquivo Pós-venda")
        self.oHelper.SetButton('Avançar')
        ...
        self.oHelper.ClickGridCell("Agência", row=2, grid_number=1)
