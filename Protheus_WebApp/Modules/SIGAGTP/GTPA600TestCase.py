...
class GTPA600(unittest.TestCase):
    ...
    def test_GTPA600_CT002(self):

        self.oHelper.SearchBrowse(
            'D MG    000298000289', 'Filial+oportunidade + Proposta')
        self.oHelper.SetButton('Outras Ações', 'Copiar')

        self.oHelper.CheckResult('G6R_PRODUT', 'GTP003')
        self.oHelper.CheckResult('G6R_PEDESC', '10,00')
        self.oHelper.CheckResult('G6R_VALACO', '900,00')
        self.oHelper.CheckResult('G6R_SA3COD', 'GTP002')
        self.oHelper.CheckResult('G6R_PROCES', 'GTP001')
        self.oHelper.CheckResult('G6R_ESTAGI', '000001')
        self.oHelper.CheckResult('G6R_TABELA', 'GTP')
        self.oHelper.CheckResult('G6R_CONDPG', '000')
        self.oHelper.CheckResult('G6R_TES', '511')
    ...
    def test_GTPA600_CT003(self):
        self.oHelper.SearchBrowse(
            'D MG    000298000289', 'Filial+oportunidade + Proposta')
        self.oHelper.SetButton('Outras Ações', 'Fin. Contrato')
