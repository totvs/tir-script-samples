...
class TMKA271(unittest.TestCase):
	...
	def test_TMKA271_CT013(self):
		...
		self.oHelper2.AddParameter("MV_PVRECAL","D MG 01",".F.",".F.",".F.")
		...
		self.oHelper2.SetValue("UB_PRODUTO", "TMK000000000000000000000000000", grid=True)
	...
	def test_TMKA271_CT044(self):
		...
		self.oHelper2.SetValue("UB_PRODUTO", "TMK000000000000000000000000012", grid=True)
		...
		self.oHelper2.CheckResult("UB_PRODUTO", "TMK000000000000000000000000012", grid=True)
