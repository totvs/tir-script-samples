...
class AGRA650(unittest.TestCase):
    ...
    def test_AGRA650_CT001(self):
        #Cenário 001: Inclusão de fardos
    ...
    def test_AGRA650_CT002(self):         
        #Cenário 002: Exclusão de fardos
        self.oHelper.SearchBrowse("D MG 01 "+"1920           "+"00001K")
        self.oHelper.SetButton("Outras Ações","Excluir Fardos",position=1, check_error=True) 
        self.oHelper.ClickLabel("Etiqueta")
        self.oHelper.ClickBox("Etiqueta","00000000000010003527",grid_number = 1) 
        self.oHelper.SetButton("Salvar")
        
        self.oHelper.SearchBrowse("D MG 01 "+"1920           "+"00001K")
        self.oHelper.SetButton("Outras Ações","Excluir Fardos",position=1, check_error=True) 
        self.oHelper.CheckResult("Etiqueta", user_value = "00000000000010003527", grid=True, line=3)
    ...
    def test_AGRA650_CT003(self):
        ...
        #Cenário 003: Reclassificação de bloco
